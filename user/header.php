<header id="header" class="fixed-top d-flex align-items-center position-sticky">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
            <h1><a href="app.php?page=home">Manusia Sehat</a></h1>
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li><strong class="px-2">Hai <?= $_SESSION['name'] ?>!</strong></li>
                <li><a class="nav-link scrollto" href="#webinar">Webinar</a></li>
                <li><a class="nav-link scrollto" href="#konseling">Konseling</a></li>
