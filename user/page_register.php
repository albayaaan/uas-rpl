                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="image col-lg-5 d-flex align-items-stretch justify-content-center justify-content-xl-start" data-aos="fade-right" data-aos-delay="150">
                            <img src="assets/img/register.png" alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="offset-1 col-lg-6 col-md-12 align-self-center" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <form action="register.php" method="post">
                                ...
                                <div class="text-center mt-3"><button type="submit" class="btn btn-primary">Daftar</button></div>
                                <div class="mt-3 text-center">
                                    <p>Sudah punya akun? <a href="page_login.php">Masuk</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
